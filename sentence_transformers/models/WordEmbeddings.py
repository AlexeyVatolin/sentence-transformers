...
class WordEmbeddings(nn.Module):
    def __init__(self, tokenizer: WordTokenizer, embedding_weights, update_embeddings: bool = False,
    ...
    def get_config_dict(self):
        return {'tokenizer_class': fullname(self.tokenizer), 'update_embeddings': self.update_embeddings,
    ...
    def load(input_path: str):
        ...
        model = WordEmbeddings(tokenizer=tokenizer, embedding_weights=embedding_weights,
    ...
    def from_text_file(embeddings_file_path: str, update_embeddings: bool = False, item_separator: str = " ",
                       tokenizer=WhitespaceTokenizer(), max_vocab_size: int = None):
        ...
        with gzip.open(embeddings_file_path, "rt", encoding="utf8") if embeddings_file_path.endswith('.gz') else open(
                embeddings_file_path, encoding="utf8") as fIn:
