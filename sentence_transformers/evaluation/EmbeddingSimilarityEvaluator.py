...
class EmbeddingSimilarityEvaluator(SentenceEvaluator):
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1,
        ...
        if wandb_available and wandb.run is not None:
            wandb.log(dict(zip(self.csv_headers[2:], [eval_pearson_cosine, eval_spearman_cosine, eval_pearson_euclidean,
                                                      eval_spearman_euclidean, eval_pearson_manhattan,
                                                      eval_spearman_manhattan,
                                                      eval_pearson_dot, eval_spearman_dot])), step=global_step)
